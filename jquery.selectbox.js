...
(function ($) {
    ...
    function Selectbox() {
        ...
        this._defaults = { // Global defaults for all the select box instances
            ...
            classOptionsList: "sbOptionsList",
            classOptionsItem: "sbOptionsItem",
            classOptionSelected: "sbOptionSelected",
            classGroup: "sbGroup",
            classSub: "sbSub",
            classDisabled: "sbDisabled",
            classSelectOpen: "sbSelectOpen",
            classToggle: "sbToggle",
            classFocus: "sbFocus",
            classDropUp: "sbDropUp",
            minWidth: 50,
            maxWidth: 500,
            maxHeight: 300,
            padding: 30,
    ...
    $.extend(Selectbox.prototype, {
        ...
        _attachSelectbox: function (target, settings) {
            ...
            var sbHolderWidth = $target.outerWidth();
        ...
        _changeSelectbox: function (target, value, text, index) {
            ...
            if (inst) {
                ...
                $sbOptions
                    .find('.' + inst.settings.classOptionSelected).removeClass(inst.settings.classOptionSelected);
                $sbOptions
